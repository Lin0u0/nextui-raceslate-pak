...
CORE_SRCS := src/rs_season.c src/rs_standings.c src/rs_results.c src/rs_weather.c src/rs_reference.c src/rs_circuit_atlas.c src/rs_profiles.c src/rs_timezone.c src/rs_app.c vendor/cJSON.c
