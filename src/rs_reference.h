...
typedef struct { char provider_id[48]; double length_km; int turns; char direction[24]; int first_year; int races; char lap_record[24]; char record_driver[64]; int record_year; char recent_winners[384]; } RsCircuitReference;
